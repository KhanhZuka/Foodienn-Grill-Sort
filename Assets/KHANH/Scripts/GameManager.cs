...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField] private int _totalFood; // tong so loai thuc an, vi du 18/30
    ...
    public void OnMinusFood()
    {
        -- _allFood;
        _completedFood++;
        _foodProgressText.text = _completedFood.ToString() + "/" + (_allFood+_completedFood).ToString(); 
        if(_allFood <= 0)
        {
